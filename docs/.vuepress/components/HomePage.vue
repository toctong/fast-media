  ...
  >
    ...
    <header class="nav reveal" data-reveal>
      ...
      <div class="nav-actions">
        <a class="btn primary magnet" :href="linkStart">开始使�?/a>
      </div>
    </header>
    ...
    <section id="story" class="story-bridge reveal" data-reveal>
      ...
      <h2>从「想补这集」到「库里可播」，全部收进同一控制�?/h2>
      <p>
        Fast Media �?RSS 追更、规则搜种�?15/CD2 整理、STRM 同步�?Emby 302 直链连成闭环—�?
        自动化可感知、可干预�?
      </p>
    </section>
    ...
    <section class="section quote reveal" data-reveal>
      <blockquote>
        「一切皆插件」让工具拥有生命力——Fast Media �?Emby�?15、CD2、RSS �?AI 助手放进同一控制面，
    ...
    <section class="cta reveal" data-reveal>
      ...
      <div class="cta-actions">
        <a class="btn primary lg magnet" :href="linkStart">快速开�?/a>
...
const features = [
  {
    ...
    points: ['豆瓣 / TMDB / 腾讯 / B �?, '全局搜索跨探�?· 频道 · RSS', '详情补全海报与演职人�?],
  ...
  },
  {
    ...
    points: ['影视订阅 + Emby 库状�?, 'RSS 站点优先级与认证', '下载进度 / 历史卡片'],
  ...
  },
  {
    ...
    title: '整理与入�?,
    tone: '#7dd3fc',
    desc: '归档规则、智能重命名�?STRM 生成，把「下完了」变成「库里能播」�?,
    points: ['归档刮削任务', '115 链接同步 STRM', 'CD2 跨存储搬�?],
  ...
  },
  {
    ...
    points: ['多实�?Emby 302', 'MCP 系统工具目录', '通知 / 日志 / Cron'],
...
const steps = [
  ...
  {
    title: '搜种 / 推�?,
    desc: 'RSS 多站并发搜种，按规则挑包；磁力可�?115 云下载或 qB/TR�?,
  },
  {
    title: '整理 / 同步',
    desc: '下载完成后走归档命名�?15 侧生�?STRM，按需 CD2 搬运�?,
  },
  {
    title: '刷新 / 播放',
...
const plugins = [
  ...
  {
    name: '智能助手',
    desc: 'OpenAI 兼容协议 + �?MCP 工具，读�?写操作可授权�?,
